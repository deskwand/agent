        ...
        while (ancestor !== path.dirname(ancestor)) {
          ...
          try {
            ...
            if (!isPathWithinRoot(realAncestor, this.workspacePath)) {
              throw new Error(
                `Resolved ancestor path is outside workspace: ${realAncestor}`,
              );
            }
            return resolved;
    ...
    switch (method) {
      ...
      case "executeCommand":
        return this.executeCommand(
          params as Parameters<typeof this.executeCommand>[0],
        );
      ...
      case "listDirectory":
        return this.listDirectory(
          params as Parameters<typeof this.listDirectory>[0],
        );
      ...
      case "createDirectory":
        return this.createDirectory(
          params as Parameters<typeof this.createDirectory>[0],
        );
