...
export const CORE_MEMORY_UPDATE_SYSTEM_PROMPT =
  DEFAULT_MEMORY_PROMPTS.coreMemoryUpdateSystemPrompt;
export const SESSION_CHUNK_EXTRACTION_PROMPT =
  DEFAULT_MEMORY_PROMPTS.sessionChunkExtractionPrompt;
export const PROMPT_ITERATION_SYSTEM_PROMPT =
  DEFAULT_MEMORY_PROMPTS.promptIterationSystemPrompt;
