  ...
  it('extracts screenshot path from wrapped screenshot output', () => {
    const output = JSON.stringify({
      content: [
        {
          type: 'text',
          text: 'Took a screenshot of the full current page.\nSaved screenshot to /Users/haoqing/Desktop/oma/agent_papers_summary_screenshot.png.',
        },
      ],
    });
    expect(extractFilePathFromToolOutput(output)).toBe('/Users/haoqing/Desktop/oma/agent_papers_summary_screenshot.png');
  });
